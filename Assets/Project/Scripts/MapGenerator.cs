...
public class MapGenerator : MonoBehaviour
{
    ...
    //a coord that will represent the center of the map, where the player will always spawn (therefore it will be always without any obstacle)
    Coord mapCenter;
    ...
    public void GenerateMap()
    {
        ...
        for(int i = 0; i < obstacleCount; i++)
        {
            ...
            if(randomCoord != mapCenter && MapIsFullyAccessible(obstacleMap, currentObstacleCount))
            {
                ...
                Transform newObstacle = Instantiate(obsctaclePrefab, obstaclePosition + Vector3.up * 0.5f, Quaternion.identity) as Transform;
